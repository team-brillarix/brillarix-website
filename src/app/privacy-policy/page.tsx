    ...
    <div className="min-h-[calc(100vh-120px)] bg-background">
      <div className="flex flex-col p-4 sm:p-6 md:p-8">
        ...
        <div className="flex flex-col gap-4 pb-6">
          ...
          <p className="text-sm sm:text-base text-gray-light-1">
        ...
        <div className="flex flex-col gap-4 pb-6">
          <Heading
            ...
            subtitleAs="p"
            subtitleClassName="text-sm sm:text-base text-gray-light-1"
        ...
        <div className="flex flex-col gap-4 pb-6">
          ...
          <p className="text-sm sm:text-base text-gray-light-1 leading-relaxed mt-2">
