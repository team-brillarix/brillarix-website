...
export function InnovatorCard({ innovator }: InnovatorCardProps) {
  return (
    <div className="flex flex-col backdrop-blur-xs justify-between bg-gray-dark-1/35 rounded-3xl p-10 border border-gray-dark-3 gap-4 surface-gradient-with-noise relative h-100 w-148">
      {/* Profile Section */}
      <div className="flex flex-row items-center justify-between gap-4">
        ...
        {/* Role Tag */}
        <div className="flex items-center justify-center h-11 min-w-36 rounded-full bg-gray-dark-3 border border-gray-dark-3 shrink-0">
